...
class RedirectTest < ActiveSupport::TestCase
  ...
  def test_redirect_chain_is_followed_and_captured
    ...
    assert_equal Dummy::test_file(name: 'greeting.txt', redirect: '0'), greeting.resource.redirected_to
  end
  ...
  def test_relative_redirect
    ...
    greeting.fetch
    assert_equal 200, greeting.resource.status_code
    assert_equal Dummy::test_file(name: 'greeting.txt', relative_redirect: '0'), greeting.resource.redirected_to
  end
